...
\begin{enumerate}[(1)]
    ...
    \item Der Vorsitzende führt die Geschäfte des FSK und trägt dafür die Verantwortung. Er vertritt die FK gegenüber dem SP, sonstigen Organen der Studierendenschaft und der Universität.
...
\begin{enumerate}[(1)]
    ...
    \end{enumerate}
    \item Zu einer Meldung zur Geschäftsordnung erteilt die Sitzungsleitung das Wort unmittelbar und außerhalb der Redeliste; ein laufender Redebeitrag darf nicht unterbrochen werden. Meldungen zur GO werden durch das Heben beider Hände angezeigt.
...
\begin{enumerate}[(1)]
    ...
    \item Der Vorsitzende des FSK hat die zitierte Fachschaft oder Person hierüber frühzeitig zu informieren. Mitglieder der Fachschaften und des FSK haben vor Abstimmungen offenzulegen, ob sie durch Annahme persönlich oder als Mitglied einer Organisation profitieren (Befangenheit). Dies gilt insbesondere für Beschlüsse zu Beitragsordnungen, Haushaltsplänen und der Satzung der Studierendenschaft.
\end{enumerate}
...
\begin{enumerate}[(1)]
    ...
    \item Die Kandidaten haben sich auf Verlangen vorzustellen.Das Amt des Vorsitzenden des FSK ist unvereinbar mit der Mitgliedschaft in einer FSV, der Mitgliedschaft in einem FSR oder einem weiteren Amt innerhalb des AStA.
...
\begin{enumerate}[(1)]
    ...
    \item Das FSK wirkt unbeschadet der Aufsichtsrechte des Rektorates darauf hin, dass die Organe der Fachschaften ihre Aufgaben und Pflichten im Rahmen der gesetzlichen Bestimmungen, der HWVO und dieser Satzung erfüllen und teilt Unterlassungen oder Verstöße der FK mit. Hält das FSK Beschlüsse, Haushaltsführung, Maßnahmen oder Unterlassungen der Fachschaften für rechtswidrig, so kann sie mit der Mehrheit seiner Mitglieder oder Abhilfe verlangen. Dies ist der FK zu berichten. Sollte durch die betroffene Fachschaft innerhalb einer angemessenen Frist keine Abhilfe geschaffen werden, so hat der Vorsitz des FSK das Rektorat zu informieren. Der Vorsitz des FSK hat das Recht und auf Antrag des Vorsitzes eines Fachschaftsrates die Pflicht das Rektorat unverzüglich zu informieren.
\end{enumerate}
...
\begin{enumerate}[(1)]
    ...
    \begin{enumerate}
        \item der Wahlprüfungsausschuss (WPAF)
        \item der Geschäftsordnungs- und Satzungsausschuss (GoSaFK)
        \item der Haushaltsausschuss (HauF)
    \end{enumerate}
    ...
    \item Der Satzungs- und Geschäftsordnungsausschuss (GoSaFK) ist für die Ausarbeitung von Dokumenten, welche die Arbeit der Fachschaften regeln, zuständig. Dazu gehören insbesondere diese Geschäftsordnung (FKGO) und die Wahlordnung für die Wahlen der Fachschaftsvertretungen und Fachschaftsräte (FSWO). 
    \item Der Haushaltsausschuss ist in Abstimmung mit FSK und AStA Finanzreferat zuständig für die Planung der Selbstbewirtschaftungsmittel der Fachschaften in Anlage 1 zur FKGO, Beitragsordnung (BO) und im Haushaltsplan der Studierendenschaft. Der HauF erarbeitet die Beschlussempfehlungen der FK bezüglich dem HHP und der BO; er ist durch das FSK hierfür mindestens 14 Tage vorher anzurufen und mit den nötigen Informationen zur Haushaltführung der Fachschaften zu versorgen. Vositz des Hauf muss ein Mitglied des FSK sein.
\end{enumerate}
...
\begin{enumerate}[(1)]
    ...
    \item Für alle Gremien gelten § 23 Abs. 3 bis 5 gelten entsprechend.
...
\begin{enumerate}[(1)]
    ...
    \begin{enumerate}[1.]
        ...
        \item die von Wahlleiter, Vorsitzendem und Protokollanten unterschriebenen Protokolle der konstituierenden Fachschaftsvertretungssitzungen der Fachschaftsvertretungen, die im Antragszeitraum im Amt waren,
...
\begin{enumerate}[(1)]
    \item Der Sockelsatz der AFsG beträgt 1000 €; es sei denn in Anlage I zur FKGO werden Änderungen für bestimmte Semester festgeschrieben. 
...
\begin{enumerate}[(1)]
    ...
    \item Die genaue Höhe und Ausgestaltung der BFsG bestimmt sich nach § 30 und Anlage XX.
\end{enumerate}
...
\begin{enumerate}[(1)]
    ...
    \item Es werden nur für folgende Kostenpunkte Anträge gewährt:
    \begin{enumerate}[a.]
        \item Erstsemesterarbeit
        \item Fachschaftsarbeitswochenenden, 
        \item Erstsemesterfahrten
        \item Fahrten zu Fachschaftsversammlungen
        \item für die Durchführung von landes-, bundes-, europa- oder weltweiten Fachschaftsversammlungen in Bonn.
        \item für den Kauf oder die Reparatur von EDV Geräten.
        \item Als Zuschuss für Fachschaften, die sich neu gründen.
        \item pro Semester und Fachschaft für inhaltliche Veranstaltungen.
    \end{enumerate}
    \item Zur näheren Definition dieser Punkte ist Anlage 2 zu berücksichtigen.
...
\begin{enumerate}[(1)]
    ...
    \item Veranstaltungen die nicht nach Anlage 2 als inhaltlich definiert sind, bleiben auch durch Vorankündigung nicht förderbar.
\end{enumerate}
...
Das FSK stellt den Fachschaften einen aktuellen Geschäftsordnungsauszug über die Regelungen zur Verteilung und Beantragung der für die Fachschaften eingezogenen Beträge zur Verfügung [Kriterienkatalog].
